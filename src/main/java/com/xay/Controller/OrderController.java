...
public class OrderController {
    ...
    @RequestMapping(value = "/orders/start", method = RequestMethod.PATCH)
    public BaseResult<Object> startOrder(@RequestParam("orderId")Integer orderId){
        return orderService.startOrder(orderId);
    }

    @RequestMapping(value = "/orders/cancel", method = RequestMethod.PATCH)
    public BaseResult<Object> cancelOrder(@RequestParam("orderId")Integer orderId){
